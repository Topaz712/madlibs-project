...
const story = `My friends and I love to hang out and read <b>${adj1}</b>. If only <b>${noun1}</b> was alway that way, we think <b>${adj2}</b> is the best thing since <b>${clothing}</b> was made. <b>${bodyPart}</b> can be a fascinating thing according to our <b>${verb1}</b>, but once we decide to eat <b>${food}</b> we know it was well worth the drive!`;
